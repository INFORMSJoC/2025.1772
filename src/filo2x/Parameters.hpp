#ifndef _FILO2X_PARAMETERS_HPP_
#define _FILO2X_PARAMETERS_HPP_
...
#define TOKEN_SOLVERS_NUM ("--solvers-num")
...
public:
    ...
    inline int get_solvers_num() const {
        return solvers_num;
    }
    ...
    void set(const std::string& key, const std::string& value) {
        ...
        } else if (key == TOKEN_SOLVERS_NUM) {
            solvers_num = std::stoi(value);
        } else {
...
private:
    ...
    int solvers_num = DEFAULT_SOLVERS_NUM;
};
