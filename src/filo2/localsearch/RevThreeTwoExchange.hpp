...
namespace cobra {
    ...
    protected:
        ...
        inline void execute(Solution &solution, const MoveGenerator &move, SparseIntSet &affected_vertices) override {
            ...
            solution.insert_vertex_before<record>(jRoute, jNextNextNext, i);
            solution.insert_vertex_before<record>(jRoute, jNextNextNext, iPrev);
            solution.insert_vertex_before<record>(jRoute, jNextNextNext, iPrevPrev);
