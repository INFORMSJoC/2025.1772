...
namespace cobra {
    ...
    template <bool record, bool handle_partial_solutions = false>
    ...
    public:
        RandomizedVariableNeighborhoodDescent(const Instance& instance_, MoveGenerators& moves_, const std::vector<Operator>& operator_list,
            ...
            OperatorInitTable[E10] = [this, tolerance]() {
                return new CommonOperator<OneZeroExchange<record>, handle_partial_solutions>(instance, moves, tolerance);
            };
            OperatorInitTable[E11] = [this, tolerance]() {
                return new CommonOperator<OneOneExchange<record>,  handle_partial_solutions>(instance, moves, tolerance);
            };
            OperatorInitTable[E20] = [this, tolerance]() {
                return new CommonOperator<TwoZeroExchange<record>,  handle_partial_solutions>(instance, moves, tolerance);
            };
            OperatorInitTable[E21] = [this, tolerance]() {
                return new CommonOperator<TwoOneExchange<record>,  handle_partial_solutions>(instance, moves, tolerance);
            };
            OperatorInitTable[E22] = [this, tolerance]() {
                return new CommonOperator<TwoTwoExchange<record>,  handle_partial_solutions>(instance, moves, tolerance);
            };
            OperatorInitTable[E30] = [this, tolerance]() {
                return new CommonOperator<ThreeZeroExchange<record>,  handle_partial_solutions>(instance, moves, tolerance);
            };
            OperatorInitTable[E31] = [this, tolerance]() {
                return new CommonOperator<ThreeOneExchange<record>,  handle_partial_solutions>(instance, moves, tolerance);
            };
            OperatorInitTable[E32] = [this, tolerance]() {
                return new CommonOperator<ThreeTwoExchange<record>,  handle_partial_solutions>(instance, moves, tolerance);
            };
            OperatorInitTable[E33] = [this, tolerance]() {
                return new CommonOperator<ThreeThreeExchange<record>,  handle_partial_solutions>(instance, moves, tolerance);
            };
            OperatorInitTable[SPLIT] = [this, tolerance]() {
                return new CommonOperator<SplitExchange<record>,  handle_partial_solutions>(instance, moves, tolerance);
            };
            OperatorInitTable[TAILS] = [this, tolerance]() {
                return new CommonOperator<TailsExchange<record>,  handle_partial_solutions>(instance, moves, tolerance);
            };
            OperatorInitTable[TWOPT] = [this, tolerance]() {
                return new CommonOperator<TwoOptExchange<record>,  handle_partial_solutions>(instance, moves, tolerance);
            };
            OperatorInitTable[EJCH] = [this, tolerance]() {
                ...
                return new CommonOperator<EjectionChain<record, /*max_relocation_nodes=*/25>,  false>(instance, moves, tolerance);
            };
            OperatorInitTable[RE20] = [this, tolerance]() {
                return new CommonOperator<RevTwoZeroExchange<record>,  handle_partial_solutions>(instance, moves, tolerance);
            };
            OperatorInitTable[RE21] = [this, tolerance]() {
                return new CommonOperator<RevTwoOneExchange<record>,  handle_partial_solutions>(instance, moves, tolerance);
            };
            OperatorInitTable[RE22B] = [this, tolerance]() {
                return new CommonOperator<RevTwoTwoExchange<record, /*reverse_both_strings=*/true>,  handle_partial_solutions>(instance, moves, tolerance);
            };
            OperatorInitTable[RE22S] = [this, tolerance]() {
                return new CommonOperator<RevTwoTwoExchange<record, /*reverse_both_strings=*/false>,  handle_partial_solutions>(instance, moves, tolerance);
            };
            OperatorInitTable[RE30] = [this, tolerance]() {
                return new CommonOperator<RevThreeZeroExchange<record>,  handle_partial_solutions>(instance, moves, tolerance);
            };
            OperatorInitTable[RE31] = [this, tolerance]() {
                return new CommonOperator<RevThreeOneExchange<record>,  handle_partial_solutions>(instance, moves, tolerance);
            };
            OperatorInitTable[RE32B] = [this, tolerance]() {
                return new CommonOperator<RevThreeTwoExchange<record, /*reverse_both_strings=*/true>,  handle_partial_solutions>(instance, moves, tolerance);
            };
            OperatorInitTable[RE32S] = [this, tolerance]() {
                return new CommonOperator<RevThreeTwoExchange<record, /*reverse_both_strings=*/false>,  handle_partial_solutions>(instance, moves, tolerance);
            };
            OperatorInitTable[RE33B] = [this, tolerance]() {
                return new CommonOperator<RevThreeThreeExchange<record, /*reverse_both_strings=*/true>,  handle_partial_solutions>(instance, moves, tolerance);
            };
            OperatorInitTable[RE33S] = [this, tolerance]() {
                return new CommonOperator<RevThreeThreeExchange<record, /*reverse_both_strings=*/false>,  handle_partial_solutions>(instance, moves, tolerance);
            };
